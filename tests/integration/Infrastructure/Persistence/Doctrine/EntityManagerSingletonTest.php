...
namespace Datamaps\Tests\Integration\Infrastructure\Persistence\Doctrine;
...
class EntityManagerSingletonTest extends TestCase
{
    ...
    {
        $this->databaseUrl =
            'mysql://root:logipro@datamaps-mariadb:3306/datamaps?serverVersion=10.9.3-MariaDB&amp;charset=utf8mb4';
    }
